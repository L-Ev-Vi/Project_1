...
@pytest.fixture
def categories_list():
    return ["Перевод со счета на счет", "Открытие вклада", "Перевод организации"]


@pytest.fixture
def categories_list_excess():
    return ["Перевод организации", "Обналичивание", "Неизвестная операция"]
