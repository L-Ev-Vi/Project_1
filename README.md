...
форматирует дату
+ data/operations.json — это файл содержащий список банковских операций с различными счетами и валютами в формате .JSON (JavaScript Object Notation)
...
+ src/external_api.py — этот модуль использоваться для конвертации иностранной валюты в рубли через HTTP на интернет ресурс https://apilayer.com/exchangerates_data-api
